...
#Give weapons
item replace entity @s hotbar.0 with flint{Enchantments:[{id:"sharpness",lvl:2}],display:{Name:'"Combat Knife"'}}
item replace entity @s hotbar.1 with bow{Unbreakable:1b,Enchantments:[{id:"power",lvl:4}],display:{Name:'"Sniper"'}}
item replace entity @s hotbar.8 with arrow 6
