...
#Give Bow
item replace entity @s hotbar.1 with bow{Unbreakable:1b,Enchantments:[{id:"punch",lvl:2},{id:"power",lvl:1}]}
#Give piercing crossbow
item replace entity @s weapon.offhand with crossbow{Unbreakable:1b,Enchantments:[{id:"piercing",lvl:1},{id:"quick_charge",lvl:2}]}
#Give arrows
