...
item replace entity @s hotbar.0 with shears{Unbreakable:1b,Enchantments:[{id:"sharpness",lvl:2}],display:{Name:'"Battle Shears"'}}
#Give Bow
item replace entity @s hotbar.1 with bow{Unbreakable:1b,Enchantments:[{id:"punch",lvl:2}]}
#Give piercing crossbow
item replace entity @s weapon.offhand with crossbow{Unbreakable:1b,Enchantments:[{id:"quick_charge",lvl:2}]}
#Give arrows
item replace entity @s hotbar.8 with arrow 10
...
#Give piercing crossbow
#item replace entity @s weapon.offhand with crossbow{Unbreakable:1b,Enchantments:[{id:"piercing",lvl:1}]}
#Give shears as small knife
